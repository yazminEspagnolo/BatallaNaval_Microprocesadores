...
.Ltext0:
	...
	.section	.text.ShootP1,"ax",@progbits
.global	ShootP1
	.type	ShootP1, @function
ShootP1:
.LFB73:
	.file 1 "../src/main.c"
	.loc 1 177 0
...
.L__stack_usage = 0
	...
	add r30,r24
	adc r31,r25
	subi r30,lo8(-(Matriz_P2))
	sbci r31,hi8(-(Matriz_P2))
	lds r24,hundido
	lds r25,hundido+1
	lds r26,hundido+2
	st Z,r24
	...
	std Z+2,r26
	.loc 1 179 0
	lds r24,Player1_Hits
	subi r24,lo8(-(1))
	sts Player1_Hits,r24
	ret
	.cfi_endproc
.LFE73:
	.size	ShootP1, .-ShootP1
	.section	.text.ShootP2,"ax",@progbits
.global	ShootP2
	.type	ShootP2, @function
ShootP2:
.LFB74:
	.loc 1 183 0
	.cfi_startproc
...
.L__stack_usage = 0
	...
	add r30,r24
	adc r31,r25
	subi r30,lo8(-(Matriz_P1))
	sbci r31,hi8(-(Matriz_P1))
	lds r24,hundido
	lds r25,hundido+1
	lds r26,hundido+2
	st Z,r24
	...
	std Z+2,r26
	.loc 1 185 0
	lds r24,Player2_Hits
	subi r24,lo8(-(1))
	sts Player2_Hits,r24
	ret
	.cfi_endproc
.LFE74:
	.size	ShootP2, .-ShootP2
	.section	.text.Mostrar_Matriz_2,"ax",@progbits
.global	Mostrar_Matriz_2
	.type	Mostrar_Matriz_2, @function
Mostrar_Matriz_2:
.LFB78:
	.loc 1 266 0
	.cfi_startproc
...
.L__stack_usage = 2
.LVL0:
	ldi r30,lo8(Matriz_P2)
	ldi r31,hi8(Matriz_P2)
	ldi r22,lo8(Matriz_RGB)
	ldi r23,hi8(Matriz_RGB)
	ldi r28,lo8(Matriz_P2+192)
	ldi r29,hi8(Matriz_P2+192)
	rjmp .L4
.LVL1:
.L5:
.LBB54:
...
/* epilogue start */
	...
	.cfi_endproc
.LFE78:
	.size	Mostrar_Matriz_2, .-Mostrar_Matriz_2
	.section	.text.Mostrar_Matriz_1,"ax",@progbits
.global	Mostrar_Matriz_1
	.type	Mostrar_Matriz_1, @function
Mostrar_Matriz_1:
.LFB79:
	.loc 1 273 0
	.cfi_startproc
...
.L__stack_usage = 2
.LVL5:
	ldi r30,lo8(Matriz_P1)
	ldi r31,hi8(Matriz_P1)
	ldi r22,lo8(Matriz_RGB)
	ldi r23,hi8(Matriz_RGB)
	ldi r28,lo8(Matriz_P1+192)
	ldi r29,hi8(Matriz_P1+192)
	rjmp .L9
.LVL6:
.L10:
.LBB56:
...
/* epilogue start */
	...
	.cfi_endproc
.LFE79:
	.size	Mostrar_Matriz_1, .-Mostrar_Matriz_1
...
.LVL10:
/* #NOAPP */
	ldi r30,lo8(Matriz_RGB)
	ldi r31,hi8(Matriz_RGB)
	ldi r20,lo8(Matriz_RGB+192)
	ldi r21,hi8(Matriz_RGB+192)
	rjmp .L14
.LVL11:
.L15:
.LBB58:
...
.LFE80:
	...
	.section	.text.TurnoP1,"ax",@progbits
.global	TurnoP1
	.type	TurnoP1, @function
TurnoP1:
.LFB76:
	.loc 1 203 0
	.cfi_startproc
...
.LVL16:
	...
	add r30,r24
	adc r31,r25
	subi r30,lo8(-(Matriz_RGB))
	sbci r31,hi8(-(Matriz_RGB))
	lds r24,punteroP1
	lds r25,punteroP1+1
	lds r26,punteroP1+2
	st Z,r24
...
.LBE76:
	...
	.cfi_endproc
.LFE76:
	.size	TurnoP1, .-TurnoP1
	.section	.text.TurnoP2,"ax",@progbits
.global	TurnoP2
	.type	TurnoP2, @function
TurnoP2:
.LFB77:
	.loc 1 234 0
	.cfi_startproc
...
.LBE96:
	...
	.cfi_endproc
.LFE77:
	.size	TurnoP2, .-TurnoP2
	.section	.text.Game_Logic,"ax",@progbits
.global	Game_Logic
	.type	Game_Logic, @function
Game_Logic:
.LFB75:
	.loc 1 190 0
	.cfi_startproc
...
.LVL72:
	.loc 1 132 0
	ldi r24,lo8(Matriz_RGB)
	ldi r25,hi8(Matriz_RGB)
	sts p2disp+1,r25
	sts p2disp,r24
.LVL73:
	movw r30,r24
...
.LVL78:
	ldi r30,lo8(Matriz_P1)
	ldi r31,hi8(Matriz_P1)
	ldi r20,lo8(Matriz_P1+192)
	ldi r21,hi8(Matriz_P1+192)
	rjmp .L51
.LVL79:
.L52:
.LBB102:
...
.LBE103:
	...
	ldi r30,lo8(Matriz_P2)
	ldi r31,hi8(Matriz_P2)
	ldi r20,lo8(Matriz_P2+192)
	ldi r21,hi8(Matriz_P2+192)
	rjmp .L53
.L51:
.LVL81:
	movw r18,r30
...
.LFE81:
	...
	.comm	Turno,1,1
	.comm	ispressed,2,1
	.comm	Matriz_P2,192,1
	.comm	Matriz_P1,192,1
	.comm	Player2_Hits,1,1
	.comm	Player1_Hits,1,1
	.comm	jjoy,2,1
	.comm	ijoy,2,1
.global	msg
...
.global	arriba_max
	.section	.rodata.arriba_max,"a",@progbits
	.type	arriba_max, @object
	.size	arriba_max, 2
arriba_max:
	.zero	2
.global	arriba_min
	.section	.rodata.arriba_min,"a",@progbits
	.type	arriba_min, @object
	.size	arriba_min, 2
arriba_min:
	.word	200
.global	abajo_max
	.section	.rodata.abajo_max,"a",@progbits
	.type	abajo_max, @object
	.size	abajo_max, 2
abajo_max:
	.word	1023
.global	abajo_min
	.section	.rodata.abajo_min,"a",@progbits
	.type	abajo_min, @object
	.size	abajo_min, 2
abajo_min:
	.word	800
.global	izquierda_max
	.section	.rodata.izquierda_max,"a",@progbits
	.type	izquierda_max, @object
	.size	izquierda_max, 2
izquierda_max:
	.zero	2
.global	izquierda_min
	.section	.rodata.izquierda_min,"a",@progbits
	.type	izquierda_min, @object
	.size	izquierda_min, 2
izquierda_min:
	.word	200
.global	derecha_max
	.section	.rodata.derecha_max,"a",@progbits
	.type	derecha_max, @object
	.size	derecha_max, 2
derecha_max:
	.word	1023
.global	derecha_min
	.section	.rodata.derecha_min,"a",@progbits
	.type	derecha_min, @object
	.size	derecha_min, 2
derecha_min:
	.word	800
	.comm	ContadorPuntero,2,1
	.comm	Matriz_RGB,192,1
.global	punteroP2
	.section	.data.punteroP2,"aw",@progbits
	.type	punteroP2, @object
	.size	punteroP2, 3
punteroP2:
	.byte	40
	.byte	5
	.byte	25
.global	punteroP1
	.section	.data.punteroP1,"aw",@progbits
	.type	punteroP1, @object
	.size	punteroP1, 3
punteroP1:
	.byte	25
	.byte	15
...
Apagado:
	.zero	3
.global	tocado
	.section	.data.tocado,"aw",@progbits
	.type	tocado, @object
	.size	tocado, 3
tocado:
	.byte	100
...
hundido:
	...
	.byte	0
.global	disparado
	.section	.data.disparado,"aw",@progbits
	.type	disparado, @object
	.size	disparado, 3
disparado:
	.byte	100
	.byte	0
...
.Ldebug_macro0:
	...
	.uleb128 0x3
	.long	.LASF2090
	.file 37 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\stdio.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x25
	.byte	0x5
	.uleb128 0x28
	.long	.LASF2091
	.file 38 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stdarg.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x26
	.byte	0x7
	...
	.long	.LASF2143
	.byte	0x4
	.file 39 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\math.h"
	.byte	0x3
	.uleb128 0x2e
	.uleb128 0x27
	.byte	0x7
	...
	.long	.LASF2203
	.byte	0x4
	.file 43 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\string.h"
	.byte	0x3
	.uleb128 0x11
	.uleb128 0x2b
	.byte	0x7
...
.LASF2234:
	.string	"Mostrar_Matriz_1"
.LASF2233:
	.string	"Mostrar_Matriz_2"
.LASF1293:
	.string	"MUX2 2"
.LASF997:
	.string	"OCF2A 1"
...
.LASF2267:
	.string	"set_P1"
.LASF2140:
	.string	"__DELAY_BACKWARD_COMPATIBLE__ "
.LASF876:
